 ...
 * @since 1.0.0
 */
function ysPoet_the_custom_logo() {
 ...
 * @since 1.0.0
 */
function ysPoet_the_site_title() {
	 ...
	 * @var string
	 */
	echo (string) apply_filters( 'ysPoet_the_site_title', $html );
 ...
 * @since 1.0.0
 */
function ysPoet_the_site_description() {
	 ...
	 * @var string
	 */
	echo (string) apply_filters( 'ysPoet_the_site_description', $html );
 ...
 * @since 1.0.0
 */
function ysPoet_the_page_title() {

	if ( $title = ysPoet_get_the_page_title() ) {
...
function ysPoet_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		...
		<h1 class="screen-reader-text"><?php esc_html_e( 'Posts navigation', 'ysPoet' ); ?></h1>

		<div class="nav-links">

		<?php if ( get_next_posts_link() ) : ?>

			<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'ysPoet' ) ); ?></div>

		<?php endif; ?>

		<?php if ( get_previous_posts_link() ) : ?>

			<div class="nav-next"><?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'ysPoet' ) ); ?></div>
...
function ysPoet_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<h1 class="screen-reader-text"><?php esc_html_e( 'Post navigation', 'ysPoet' ); ?></h1>
...
function ysPoet_breadcrumbs() {
	...
	if ( ! is_front_page() ) {
		...
		if ( 'page' === get_option( 'show_on_front' ) ) {
			...
			printf(
				'<a href="%s">%s</a>%s',
				esc_url( ysPoet_get_posts_url() ),
				esc_html__( 'Blog', 'ysPoet' ),
				$separator // xss ok
			);
...
/**
 * Display custom numbered pagination.
 * 
 * @param  string $numpages  max number of pages
 * @param  string $pagerange page range
 * @param  string $paged     current page number
 * 
 * @since 1.0.0
 */
function ysPoet_custom_pagination($numpages = '', $pagerange = '', $paged='') {
