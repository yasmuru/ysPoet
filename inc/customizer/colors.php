...
class ysPoet_Customizer_Colors {
	...
	public function __construct() {
		 ...
		 * @var array
		 */
		$this->colors = (array) apply_filters( 'ysPoet_colors',
			array(
				/**
				 * Text colors
				 */
				'header_textcolor' => array(
					'label'           => esc_html__( 'Site Title Text', 'ysPoet' ),
					'default'         => '#ffffff',
				...
				'tagline_text_color' => array(
					'label'           => esc_html__( 'Tagline Text', 'ysPoet' ),
					'default'         => '#ffffff',
					'section'         => 'colors-header',
					'active_callback' => 'display_header_text',
					'css'             => array(
				...
				'hero_text_color' => array(
					'label'    => esc_html__( 'Hero Text', 'ysPoet' ),
					'default'  => '#ffffff',
					'section'  => 'colors-header',
					'priority' => 20,
					'css'      => array(
				...
				'heading_text_color' => array(
					'label'       => esc_html__( 'Heading Text', 'ysPoet' ),
					'description' => esc_html__( 'Post titles, widget titles, form labels, table headers and buttons.', 'ysPoet' ),
					'default'     => '#353535',
				...
				'primary_text_color' => array(
					'label'       => esc_html__( 'Primary Text', 'ysPoet' ),
					'description' => esc_html__( 'Paragraphs, lists, menu links, quotes and tables.', 'ysPoet' ),
					'default'     => '#252525',
					'section'     => 'colors-content',
					'css'         => array(
						'body,
				...
				'secondary_text_color' => array(
					'label'       => esc_html__( 'Secondary Text', 'ysPoet' ),
					'description' => esc_html__( 'Post bylines, comment counts, post footers and quote footers.', 'ysPoet' ),
					'default'     => '#686868',
					'section'     => 'colors-content',
					'css'         => array(
						'blockquote,
				...
				'footer_widget_heading_text_color' => array(
					'label'           => esc_html__( 'Widget Heading Text', 'ysPoet' ),
					'default'         => '#353535',
					'section'         => 'colors-footer',
					'active_callback' => 'ysPoet_has_active_footer_sidebars',
					'css'             => array(
				...
				'footer_widget_text_color' => array(
					'label'           => esc_html__( 'Widget Text', 'ysPoet' ),
					'default'         => '#252525',
					'section'         => 'colors-footer',
					'active_callback' => 'ysPoet_has_active_footer_sidebars',
					'css'             => array(
				...
				'footer_menu_text_color' => array(
					'label'           => esc_html__( 'Menu Text', 'ysPoet' ),
					'default'         => '#686868',
					'section'         => 'colors-footer',
					'priority'        => 20,
					'active_callback' => 'ysPoet_has_footer_menu',
					'css'             => array(
						'.footer-menu ul li a,
				...
				'footer_text_color' => array(
					'label'    => esc_html__( 'Copyright Text', 'ysPoet' ),
					'default'  => '#686868',
					'section'  => 'colors-footer',
					'priority' => 30,
					'css'      => array(
				 ...
				 */
				'link_color' => array(
					'label'   => esc_html__( 'Link Text', 'ysPoet' ),
					'default' => '#ff6663',
					'section' => 'colors-content',
					'css'     => array(
						'a, a:visited,
				...
				'button_color' => array(
					'label'   => esc_html__( 'Background', 'ysPoet' ),
					'default' => '#ff6663',
				...
				'background_color' => array(
					'label'   => esc_html__( 'Page Background', 'ysPoet' ),
					'default' => '#f5f5f5',
					'section' => 'colors-content',
					'css'     => array(
						'body' => array(
				...
				'content_background_color' => array(
					'label'   => esc_html__( 'Content Background', 'ysPoet' ),
					'default' => '#ffffff',
					'section' => 'colors-content',
					'css'     => array(
				...
				'hero_background_color' => array(
					'label'    => esc_html__( 'Hero Background', 'ysPoet' ),
					'default'  => '#0b3954',
					'section'  => 'colors-header',
					'priority' => 20,
					'css'      => array(
						ysPoet_get_hero_image_selector() => array(
							'background-color' => '%1$s',
						),
					),
					'rgba_css' => array(
				...
				'footer_widget_background_color' => array(
					'label'           => esc_html__( 'Widgets Background', 'ysPoet' ),
					'default'         => '#0b3954',
					'section'         => 'colors-footer',
					'active_callback' => 'ysPoet_has_active_footer_sidebars',
					'css'             => array(
				...
				'footer_widget_content_background_color' => array(
					'label'           => esc_html__( 'Widget Content Background', 'ysPoet' ),
					'default'         => '#ffffff',
					'section'         => 'colors-footer',
					'active_callback' => 'ysPoet_has_active_footer_sidebars',
					'css'             => array(
				...
				'footer_background_color' => array(
					'label'    => esc_html__( 'Footer Background', 'ysPoet' ),
					'default'  => '#f5f5f5',
					'section'  => 'colors-footer',
					'priority' => 30,
					'css'      => array(
		...
		$custom_scheme = array(
			'_custom' => array(
				'label' => sprintf( '- %s -' , esc_html__( 'Custom', 'ysPoet' ) ),
			),
		);
		 ...
		 * a `ysPoet_colors` filter in your Child Theme.
		 *
		 * @since 1.0.0
		 *
		 * @var array
		...
		$default_scheme = array(
			'default' => array(
				'label'  => esc_html__( 'Default', 'ysPoet' ),
		...
		$color_schemes = array(
			'blush' => array(
				'label' => esc_html_x( 'Blush', 'color scheme name', 'ysPoet' ),
				'base'  => '#cc494f',
			),
			'bronze' => array(
				'label' => esc_html_x( 'Bronze', 'color scheme name', 'ysPoet' ),
				'base'  => '#b1a18b',
			),
			'canary' => array(
				'label' => esc_html_x( 'Canary', 'color scheme name', 'ysPoet' ),
				'base'  => '#e9c46a',
			),
			'cool' => array(
				'label' => esc_html_x( 'Cool', 'color scheme name', 'ysPoet' ),
				'base'  => '#78c3fb',
			),
			'dark' => array(
				'label' => esc_html_x( 'Dark', 'color scheme name', 'ysPoet' ),
				'base'  => '#222222',
			),
			'iguana' => array(
				'label' => esc_html_x( 'Iguana', 'color scheme name', 'ysPoet' ),
				'base'  => '#62bf7c',
			),
			'muted' => array(
				'label' => esc_html_x( 'Muted', 'color scheme name', 'ysPoet' ),
				'base'  => '#3e4c75',
			),
			'plum' => array(
				'label' => esc_html_x( 'Plum', 'color scheme name', 'ysPoet' ),
				'base'  => '#5d5179',
			),
			'rose' => array(
				'label' => esc_html_x( 'Rose', 'color scheme name', 'ysPoet' ),
				'base'  => '#f49390',
			),
			'tangerine' => array(
				'label' => esc_html_x( 'Tangerine', 'color scheme name', 'ysPoet' ),
				'base'  => '#fc9e4f',
			),
			'turquoise' => array(
				'label' => esc_html_x( 'Turquoise', 'color scheme name', 'ysPoet' ),
				'base'  => '#48e5c2',
			),
		);
		...
		if ( ! is_child_theme() ) {
			...
			$color_schemes = ysPoet_array_replace_recursive( $color_schemes, $overrides );
		 ...
		 * @var array
		 */
		$color_schemes = (array) apply_filters( 'ysPoet_color_schemes', $color_schemes );
	...
	public function colors( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_panel(
			'colors',
			array(
				'title'       => esc_html__( 'Colors', 'ysPoet' ),
		...
		$wp_customize->add_section(
			'colors-scheme',
			array(
				'title' => esc_html__( 'Color Schemes', 'ysPoet' ),
				'panel' => 'colors',
			)
		);
		...
		$wp_customize->add_section(
			'colors-header',
			array(
				'title' => esc_html__( 'Header', 'ysPoet' ),
				'panel' => 'colors',
			)
		);
		...
		$wp_customize->add_section(
			'colors-buttons',
			array(
				'title' => esc_html__( 'Buttons', 'ysPoet' ),
				'panel' => 'colors',
			)
		);
		...
		$wp_customize->add_section(
			'colors-content',
			array(
				'title' => esc_html__( 'Content', 'ysPoet' ),
				'panel' => 'colors',
			)
		);
		...
		$wp_customize->add_section(
			'colors-footer',
			array(
				'title' => esc_html__( 'Footer', 'ysPoet' ),
				'panel' => 'colors',
			)
		);
	...
	public function add_color_inline_css( $name, array $args ) {
		...
		$css     = sprintf( ysPoet_Customizer::parse_css_rules( $args['css'] ), '#' . $hex );

		if ( ! empty( $args['rgba_css'] ) ) {

			$css .= sprintf(
				ysPoet_Customizer::parse_css_rules( $args['rgba_css'] ),
				implode( ', ', ysPoet_hex2rgb( $hex ) )
			);

		}

		wp_add_inline_style( ysPoet_Customizer::$stylesheet, $css );
	...
	public function color_scheme( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_control(
			'color_scheme',
			array(
				'label'    => esc_html__( 'Base Color Scheme', 'ysPoet' ),
	...
	public function colors_control_js() {
		...
		wp_enqueue_script( 'ysPoet-colors-control', get_template_directory_uri() . "/assets/js/admin/colors-control{$suffix}.js", array( 'customize-controls', 'iris', 'underscore', 'wp-util' ), ysPoet_VERSION, true );

		wp_localize_script( 'ysPoet-colors-control', 'colorSchemes', $this->color_schemes );
	...
	public function colors_preview_css() {
		...
		?>
		<script type="text/html" id="tmpl-ysPoet-colors-css">
			<?php
			...
			foreach ( $this->colors as $name => $args ) {
				...
				printf(
					ysPoet_Customizer::parse_css_rules( $args['css'] ),
					sprintf( '{{ data.%s }}', $name )
				);
		...
		if ( ! $rgba_colors ) {
			...
			echo '<script type="text/html" id="tmpl-ysPoet-colors-css-rgba"></script>';

		}

		?>
		<script type="text/html" id="tmpl-ysPoet-colors-css-rgba">
			<?php

			foreach ( $rgba_colors as $name => $css ) {

				printf(
					ysPoet_Customizer::parse_css_rules( $css ),
					sprintf( '{{ data.%s }}', $name )
				);
	...
	public function header() {
		 ...
		 * @var array
		 */
		$args = (array) apply_filters( 'ysPoet_custom_header_args',
			array(
		 ...
		 * @var array
		 */
		$defaults = (array) apply_filters( 'ysPoet_default_hero_images',
			array(
				'default' => array(
	...
	public function header_css() {
		...
		if ( $color && $css ) {
			...
			printf(
				"<style type='text/css'>\n%s\n</style>",
				sprintf( ysPoet_Customizer::parse_css_rules( $css ), $color )
			);
	...
	public function background() {
		 ...
		 * @var array
		 */
		$args = (array) apply_filters( 'ysPoet_custom_background_args',
			array(
	...
	public function color_overlay_transparency( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_control(
			'hero_image_color_overlay',
			array(
				'label'           => esc_html__( 'Hero Background Overlay', 'ysPoet' ),
				'description'     => esc_html__( 'Control the color overlay transparency when using a custom Header Image.', 'ysPoet' ),
				'section'         => 'colors-header',
				'priority'        => 20,
				'active_callback' => 'ysPoet_has_hero_image',
				'type'            => 'range',
				'input_attrs'     => array(
					'min'  => 0,
					'max'  => 100,
	...
	public function get_color_overlay_transparency_default_value() {
		 ...
		 * @var int
		 */
		return (int) apply_filters( 'ysPoet_hero_image_color_overlay_default', 50 );
