...
class ysPoet_Customizer_Fonts {
	...
	public function __construct() {
		 ...
		 * @var array
		 */
		$this->fonts = (array) apply_filters( 'ysPoet_fonts',
			array(
				'Architects Daughter',
				'Asap',
				'Cabin',
		 ...
		 * @var array
		 */
		$this->font_types = (array) apply_filters( 'ysPoet_font_types',
			array(
				'site_title_font' => array(
					'label'       => esc_html__( 'Site Title', 'ysPoet' ),
					'description' => esc_html__( 'Site title text in the header.', 'ysPoet' ),
					'default'     => 'Open Sans',
					'css'         => array(
						'.site-title' => array(
				...
				'navigation_font' => array(
					'label'       => esc_html__( 'Navigation', 'ysPoet' ),
					'description' => esc_html__( 'Primary menu links and button links.', 'ysPoet' ),
					'default'     => 'Open Sans',
					'css'         => array(
				...
				'heading_font' => array(
					'label'       => esc_html__( 'Headings', 'ysPoet' ),
					'description' => esc_html__( 'Post titles, widget titles, form labels, and table headers.', 'ysPoet' ),
					'default'     => 'Open Sans',
					'css'         => array(
						'h1, h2, h3, h4, h5, h6,
						label,
				...
				'primary_font' => array(
					'label'       => esc_html__( 'Primary', 'ysPoet' ),
					'description' => esc_html__( 'Paragraphs, lists, links, quotes, and tables.', 'ysPoet' ),
					'default'     => 'Open Sans',
					'css'         => array(
						'body,
						p,
				...
				'secondary_font' => array(
					'label'       => esc_html__( 'Secondary', 'ysPoet' ),
					'description' => esc_html__( 'Bylines, comment counts, reply links, post footers, and quote footers.', 'ysPoet' ),
					'default'     => 'Open Sans',
					'css'         => array(
						'blockquote,
						.entry-meta,
	...
	public function fonts( WP_Customize_Manager $wp_customize ) {
		...
		foreach ( $this->font_types as $name => $args ) {
			...
			$fonts[ $default ] = sprintf( esc_html_x( '%s (Default)', 'font name', 'ysPoet' ), $default );
	...
	public function get_font_weights( $font, $font_type ) {
		 ...
		 * @var array
		 */
		$weights = (array) apply_filters( 'ysPoet_font_weights', array( 300, 400, 700 ), $font, $font_type );
	...
	public function enqueue_google_fonts() {
		 ...
		 * @var array
		 */
		$query_args = (array) apply_filters( 'ysPoet_google_fonts_query_args',
			array(
		...
		wp_enqueue_style( ysPoet_Customizer::$stylesheet . '-fonts', add_query_arg( $query_args, '//fonts.googleapis.com/css' ), false );
	...
	public function enqueue_inline_css() {
		...
		foreach ( $this->font_types as $name => $args ) {
			...
			wp_add_inline_style( ysPoet_Customizer::$stylesheet . '-fonts', $css );
