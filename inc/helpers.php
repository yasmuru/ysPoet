 ...
 * @return string
 */
function ysPoet_get_the_page_title() {
	...
	switch ( true ) {
		...
		case is_search() :
			...
			$title = sprintf(
				esc_html_x( 'Search Results for: %s', 'search term', 'ysPoet' ),
				sprintf(
					'<span>%s</span>',
					get_search_query()
				)
		...
		case is_404() :
			...
			$title = esc_html__( '404 Page Not Found', 'ysPoet' );
	 ...
	 * @var string
	 */
	return (string) apply_filters( 'ysPoet_the_page_title', $title );
 ...
 * @return string
 */
function ysPoet_get_page_width() {
 ...
 * @return bool
 */
function ysPoet_is_fluid_width() {

	return ( 'fluid' === ysPoet_get_page_width() );
 ...
 * @return bool
 */
function ysPoet_is_fixed_width() {

	return ( 'fixed' === ysPoet_get_page_width() );
 ...
 *
 * @global string $ysPoet_customizer_layouts
 * @since  1.0.0
 *
 ...
 * @return string
 */
function ysPoet_get_layout( $post_id = null ) {

	global $ysPoet_customizer_layouts;

	$post_id = ( $post_id ) ? $post_id : get_queried_object_id();

	return $ysPoet_customizer_layouts->get_current_layout( $post_id );
 ...
 * @return string
 */
function ysPoet_get_global_layout() {

	global $ysPoet_customizer_layouts;

	return $ysPoet_customizer_layouts->get_global_layout();
 ...
 * @return bool
 */
function ysPoet_layout_has_sidebar( $layout = null ) {

	$layout      = ( $layout ) ? $layout : ysPoet_get_layout();
	 ...
	 * @var bool
	 */
	return (bool) apply_filters( 'ysPoet_layout_has_sidebar', $has_sidebar, $layout );
 ...
 * @return bool
 */
function ysPoet_has_custom_logo() {
	 ...
	 * @var bool
	 */
	return (bool) apply_filters( 'ysPoet_has_custom_logo', $enabled );
 ...
 * @return string
 */
function ysPoet_get_hero_image_selector() {
	 ...
	 * @var string
	 */
	$selector = (string) apply_filters( 'ysPoet_hero_image_selector', '.site-header' );
 ...
 * @return bool
 */
function ysPoet_use_featured_hero_image() {
	 ...
	 * @var bool
	 */
	return (bool) apply_filters( 'ysPoet_use_featured_hero_image', $enabled );
 ...
 * @return bool
 */
function ysPoet_has_hero_image() {

	return ( has_header_image() || ( ysPoet_use_featured_hero_image() && has_post_thumbnail( get_queried_object() ) ) );
 ...
 * @return string|null
 */
function ysPoet_get_hero_image() {
	 ...
	 * @var string
	 */
	$size = (string) apply_filters( 'ysPoet_hero_image_size', 'ysPoet-hero' );

	/**
	 * Featured Image (if enabled)
	 */
	if ( ysPoet_use_featured_hero_image() && ( $post = get_queried_object() ) && has_post_thumbnail( $post ) ) {
 ...
 * @return string
 */
function ysPoet_get_featured_image_size() {
	 ...
	 * @var string
	 */
	return (string) apply_filters( 'ysPoet_featured_image_size', 'ysPoet-featured' );
...
function ysPoet_get_posts_url() {
	 ...
	 * @var string
	 */
	return (string) apply_filters( 'ysPoet_posts_url', $url );
 ...
 * @return array
 */
function ysPoet_get_footer_sidebars() {
	 ...
	 * @var array
	 */
	return (array) apply_filters( 'ysPoet_footer_sidebars', $sidebars );
 ...
 * @return array
 */
function ysPoet_get_active_footer_sidebars() {

	return array_filter( ysPoet_get_footer_sidebars(), 'is_active_sidebar' );
 ...
 * @return bool
 */
function ysPoet_has_active_footer_sidebars() {

	return (bool) ysPoet_get_active_footer_sidebars();
 ...
 * @return bool
 */
function ysPoet_has_footer_menu() {
 ...
 *
 * @see   ysPoet_has_active_categories_reset()
 * @since 1.0.0
 *
 * @return bool
 */
function ysPoet_has_active_categories() {

	if ( WP_DEBUG || false === ( $has_active_categories = get_transient( 'ysPoet_has_active_categories' ) ) ) {
		...
		set_transient( 'ysPoet_has_active_categories', $has_active_categories );
	 ...
	 * @var bool
	 */
	return (bool) apply_filters( 'ysPoet_has_active_categories', ! empty( $has_active_categories ) );
 ...
 * @return array
 */
function ysPoet_array_replace_recursive( array $array1, array $array2 ) {
