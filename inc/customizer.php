...
class ysPoet_Customizer {
	...
	public function logo() {
		 ...
		 * @var array
		 */
		$args = (array) apply_filters( 'ysPoet_custom_logo_args',
			array(
				'height'      => 100,
				'width'       => 400,
				'flex-height' => true,
	...
	public function use_featured_hero_image( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_control(
			'use_featured_hero_image',
			array(
				'label'       => esc_html__( 'Use featured image', 'ysPoet' ),
				'description' => esc_html__( 'Allow the featured image on the current post to override the hero image.', 'ysPoet' ),
	...
	public function customize_preview_js() {
		...
		wp_enqueue_script( 'ysPoet-customize-preview', get_template_directory_uri() . "/assets/js/admin/customizer{$suffix}.js", array( 'customize-preview' ), ysPoet_VERSION, true );

		wp_localize_script( 'ysPoet-customize-preview', 'colorsSettings', array( 'hero_background_selector' => ysPoet_get_hero_image_selector() ) );
