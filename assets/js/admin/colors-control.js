...
( function( api, $ ) {
	...
	var cssTemplate      = wp.template( 'ysPoet-colors-css' ),
	    rgbaTemplate     = wp.template( 'ysPoet-colors-css-rgba' ),
	    colorSettings    = [],
	    oldScheme        = null,
	...
	function updateCSS() {
		...
		api.previewer.send( 'ysPoet-update-colors-css', cssTemplate( colors ) );
		api.previewer.send( 'ysPoet-update-colors-css-rgba', rgbaTemplate( rgbaColors ) );
